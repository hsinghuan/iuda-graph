...
class MeanTeacherAdapter():
    ...
    def adapt(self, tgt_train_loader, tgt_val_loader, con_trade_off_list, stage, args):
        ...
        for con_trade_off in con_trade_off_list:
            ...
            performance_dict[con_trade_off] = {'tgt_model': model, 'tgt_val_score': val_score}
        ...
        for con_trade_off, perf_dict in performance_dict.items():
            ...
            print(f"Consistency Tradeoff: {con_trade_off} val_score: {perf_dict['tgt_val_score']}")
