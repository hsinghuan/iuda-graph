    ...
    def _adapt_train_epoch(self, encoder, classifier, tgt_train_loader, optimizer, reg_weight=None):
        ...
        for _ in range(len_dataloader):
            ...
            if reg_weight:
                ...
                b = F.softmax(tgt_y[pseudo_tgt_mask], dim=1) * F.log_softmax(tgt_y[pseudo_tgt_mask], dim=1)
                b = b.sum(dim=1)
                tgt_loss += reg_weight * -1.0 * b.mean(dim=0)
